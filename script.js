        ...
        // Dashboard Slider
        const dashboardSlides = document.querySelectorAll('.dashboard-slider .dashboard-slide');
        const dashboardDots = document.querySelectorAll('.dashboard-nav .dashboard-dot');
        ...
        // Testimonial Slider
        const testimonialSlides = document.querySelectorAll('.testimonial-slider .testimonial-slide');
        const testimonialDots = document.querySelectorAll('.testimonial-nav .testimonial-dot');
